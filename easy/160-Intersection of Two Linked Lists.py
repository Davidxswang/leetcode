...
# I didn't think out the solution for this problem. Thanks to @icrtiou in the discussion area. The solution is genious.
# Basically this is make two lists connected, one is A+B, the other is B+A.
# These two will have the same length.
# Use two pointers to go from the beginning of each connected list and see if these two pointers will be the same.
